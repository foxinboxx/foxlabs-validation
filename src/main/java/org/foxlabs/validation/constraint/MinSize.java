...
@ConstrainedBy({
    SizeConstraint.StringType.class,
    SizeConstraint.CollectionType.class,
    SizeConstraint.MapType.class,
    SizeConstraint.ArrayType.class
})
public @interface MinSize {
    ...
    /**
     * Defines several <code>@MinSize</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@MinSize</code> annotations.
         */
        MinSize[] value();
