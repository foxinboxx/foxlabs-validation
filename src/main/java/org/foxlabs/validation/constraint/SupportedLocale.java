...
@ConstrainedBy(SupportedLocaleConstraint.class)
public @interface SupportedLocale {
    ...
    /**
     * Defines several <code>@SupportedLocale</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@SupportedLocale</code> annotations.
         */
