...
/**
 * Replaces the annotated empty string with <code>null</code>.
 * 
 * @author Fox Mulder
...
@ConstrainedBy(NullifyConstraint.class)
public @interface Nullify {
    ...
    /**
     * Defines several <code>@Nullify</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@Nullify</code> annotations.
         */
        Nullify[] value();
