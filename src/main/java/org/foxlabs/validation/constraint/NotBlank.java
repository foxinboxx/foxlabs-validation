...
/**
 * Checks whether the annotated string is not <code>null</code> or empty.
 * 
 * @author Fox Mulder
...
@ConstrainedBy(NotBlankConstraint.class)
public @interface NotBlank {
    ...
    /**
     * Defines several <code>@NotBlank</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@NotBlank</code> annotations.
         */
        NotBlank[] value();
