...
@ConstrainedBy(DespaceConstraint.class)
public @interface Despace {
    ...
    /**
     * Defines several <code>@Despace</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@Despace</code> annotations.
         */
        Despace[] value();
