...
@ConstrainedBy(EnumerationConstraint.Default.class)
public @interface Enumeration {
    
    /**
     * @return Array of string representations of allowed constants.
     */
    String[] value();
    ...
    /**
     * Defines several <code>@Enumeration</code> annotations on the same
     * element.
     * 
     * @author Fox Mulder
     */
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@Enumeration</code> annotations.
         */
        Enumeration[] value();
