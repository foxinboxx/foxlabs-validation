 ...
 * Image size can be adjusted according to {@link ImageAdjust} mode.
 * 
 * @author Fox Mulder
 * @see ImageSizeConstraint
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.ANNOTATION_TYPE, ElementType.METHOD, ElementType.FIELD})
@ConstrainedBy({
    ImageSizeConstraint.AwtCodec.class,
    ImageSizeConstraint.RawCodec.class
})
public @interface ImageSize {
    ...
    /**
     * Defines several <code>@ImageSize</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
