...
@ConstrainedBy(Ip6AddressConstraint.class)
public @interface Ip6Address {
    ...
    /**
     * Defines several <code>@Ip6Address</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@Ip6Address</code> annotations.
         */
        Ip6Address[] value();
