...
/**
 * Checks whether the annotated object is <code>null</code>.
 * 
 * @author Fox Mulder
...
@ConstrainedBy(IsNullConstraint.class)
public @interface IsNull {
    ...
    /**
     * Defines several <code>@IsNull</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@IsNull</code> annotations.
         */
        IsNull[] value();
