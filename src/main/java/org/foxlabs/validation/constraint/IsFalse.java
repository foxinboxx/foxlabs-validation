...
/**
 * Checks whether the annotated boolean value is <code>false</code>.
 * 
 * @author Fox Mulder
...
@ConstrainedBy(IsFalseConstraint.class)
public @interface IsFalse {
    ...
    /**
     * Defines several <code>@IsFalse</code> annotations on the same
     * element.
     * 
     * @author Fox Mulder
     */
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@IsFalse</code> annotations.
         */
        IsFalse[] value();
