...
/**
 * Replaces <code>null</code> value of the annotated date with system date.
 * 
 * @author Fox Mulder
...
@ConstrainedBy(SysdateConstraint.class)
public @interface Sysdate {
    ...
    /**
     * Defines several <code>@Sysdate</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
