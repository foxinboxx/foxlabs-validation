...
/**
 * Removes all <code>null</code> elements from the annotated sequence.
 * 
 * @author Fox Mulder
 * @see RemoveNullElementsConstraint
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.ANNOTATION_TYPE, ElementType.METHOD, ElementType.FIELD})
@ConstrainedBy({
    RemoveNullElementsConstraint.CollectionType.class,
    RemoveNullElementsConstraint.ArrayType.class
})
public @interface RemoveNullElements {
    ...
    /**
     * Defines several <code>@RemoveNullElements</code> annotations on the same
     * element.
     * 
     * @author Fox Mulder
     */
