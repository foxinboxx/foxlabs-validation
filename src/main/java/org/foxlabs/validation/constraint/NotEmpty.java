 ...
 * 
 * @author Fox Mulder
 * @see NotEmptyConstraint
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.ANNOTATION_TYPE, ElementType.METHOD, ElementType.FIELD})
@ConstrainedBy({
    NotEmptyConstraint.StringType.class,
    NotEmptyConstraint.CollectionType.class,
    NotEmptyConstraint.MapType.class,
    NotEmptyConstraint.ArrayType.class
})
public @interface NotEmpty {
    ...
    /**
     * Defines several <code>@NotEmpty</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@NotEmpty</code> annotations.
         */
        NotEmpty[] value();
