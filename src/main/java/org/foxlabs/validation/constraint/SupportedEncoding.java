...
@ConstrainedBy(SupportedEncodingConstraint.class)
public @interface SupportedEncoding {
    ...
    /**
     * Defines several <code>@SupportedEncoding</code> annotations on the same element.
     * 
     * @author Fox Mulder
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    public static @interface List {
        ...
        /**
         * @return <code>@SupportedEncoding</code> annotations.
         */
